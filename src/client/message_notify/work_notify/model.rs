...
pub struct AsyncSendResult {
    ...
    pub invalid_user_id_list: Option<String>,
    ...
    ///     如果是企业接入方式，此上限为500
    pub forbidden_user_id_list: Option<String>,
    /// 发送失败的userid
    #[serde(skip_serializing_if = "Option::is_none")]
    pub failed_user_id_list: Option<String>,
    /// 已读消息的userid
    #[serde(skip_serializing_if = "Option::is_none")]
    pub read_user_id_list: Option<String>,
    /// 未读消息的userid
    #[serde(skip_serializing_if = "Option::is_none")]
    pub unread_user_id_list: Option<String>,
    /// 无效的部门ID
    #[serde(skip_serializing_if = "Option::is_none")]
    pub invalid_dept_id_list: Option<i64>,
    /// 推送被禁止的具体原因
    #[serde(skip_serializing_if = "Option::is_none")]
    pub forbidden_list: Option<SendForbiddenModel>,
}
